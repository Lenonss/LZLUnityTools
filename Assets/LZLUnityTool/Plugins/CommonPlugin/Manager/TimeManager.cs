using System;
using LZLUnityTool.Plugins.CommonPlugin.Enmus.Time;
using LZLUnityTool.Plugins.CommonPlugin.UI;
using UnityEngine;
...
public class TimeManager : SingletonMono<TimeManager>
{
    ...
    private void CheckDayChange(Action dayChangeAct = null)
    {
        int dayNow = Days;
        if (dayBefore != dayNow)
        {
    ...
    public void SaveData<TSaveData>(TSaveData data)
    {

    }
    public void LoadData<TSaveData>(TSaveData data)
    {
        //获取时间
        //SetTime();
    }
