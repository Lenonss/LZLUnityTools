...
public class WindowsManager : SingletonMono<WindowsManager>
{
    ...
    public void CloseAll(params IWindowHandler[] exceptions)
    {
        while (WindowsCount > 0)
        {
            if (!((IList) exceptions).Contains(windowStack.Peek()))
    ...
    public void PauseAll(bool pause, params IWindowHandler[] exceptions)
    {
        ...
        {
            if (!((IList) exceptions).Contains(window))
            {
...
public abstract class WindowHandler<UI_T, Mono_T> : SingletonMono<Mono_T>, IWindowHandler, IFadeAble<WindowHandler<UI_T, Mono_T>>
    where UI_T : WindowUI where Mono_T : SingletonMono<Mono_T>
{
    [SerializeField]
    protected UI_T UI;
    ...
    public virtual void OpenWindow()
    {
        ...
        else CommonTool.FadeTo(1, animationSpeed, this);
    ...
    public virtual void CloseWindow()
    {
        ...
        else CommonTool.FadeTo(0, animationSpeed, this);
